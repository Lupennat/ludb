...
abstract class Connector implements ConnectorI {
   ...
   */
  protected getAttributes<T extends FlattedConnectionConfig<ConnectionConfig>>(
    config: T,
  ): PdoAttributes {
   ...
   */
  protected getPoolOptions<T extends FlattedConnectionConfig<ConnectionConfig>>(
    config: T,
  ): PoolOptions {
  ...
  public abstract connect(
    config: FlattedConnectionConfig<ConnectionConfig>,
  ): Pdo;
}
