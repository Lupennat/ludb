...
describe('SqlServer Schema Grammar', () => {
    ...
    it('Works Adding Date Time', () => {
        ...
        const statements = blueprint.toSql(connection);
        expect(1).toBe(statements.length);
        expect('alter table "users" add "created_at" datetime not null').toBe(statements[0]);
    });
    ...
    it('Works Adding Timestamps', () => {
        ...
        const statements = blueprint.toSql(connection);
        expect(1).toBe(statements.length);
        expect('alter table "users" add "created_at" datetime null, "updated_at" datetime null').toBe(statements[0]);
    });
