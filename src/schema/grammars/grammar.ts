...
class Grammar extends BaseGrammar {
  ...
  public compileCreateView(
    _name: Stringable,
    _command?: CommandViewDefinition<ViewRegistryI>,
  ): string {
   ...
   */
  public compileForeignKeys(
    _table: string,
    _databaseOrSchema?: string,
  ): string {
    throw new Error(
      'This database driver does not support get table foreign keys.',
    );
  }
  ...
  public compileEnableWriteableSchema(): string {
    throw new Error(
      'This database driver does not support enable writable schema.',
    );
  }
  ...
  public compileDisableWriteableSchema(): string {
    throw new Error(
      'This database driver does not support disable writable schema.',
    );
  }
  ...
  public compilePrimary(
    ...
    throw new Error(
      'This database driver does not support primary key creation.',
    );
  }
  ...
  public compileDropPrimary(
    ...
    throw new Error(
      'This database driver does not support primary key removal.',
    );
  }
  ...
  public compileUnique(
    ...
    throw new Error(
      'This database driver does not support unique index creation.',
    );
  }
  ...
  public compileDropUnique(
    ...
    throw new Error(
      'This database driver does not support unique index removal.',
    );
  }
  ...
  public compileSpatialIndex(
    ...
    throw new Error(
      'This database driver does not support spatial index creation.',
    );
  }
  ...
  public compileDropSpatialIndex(
    ...
    throw new Error(
      'This database driver does not support spatial index removal.',
    );
  }
  ...
  public compileDropForeign(
    ...
    throw new Error(
      'This database driver does not support foreign index removal.',
    );
  }
  ...
  protected compileTypeChar(column: ColumnDefinition): string {
    return (column.getRegistry().length ?? 0)
      ? `char(${column.getRegistry().length})`
      : 'char';
  }
  ...
  protected compileTypeString(column: ColumnDefinition): string {
    return (column.getRegistry().length ?? 0)
      ? `varchar(${column.getRegistry().length})`
      : 'varchar';
  }
  ...
  protected compileTypeDouble(column: ColumnDefinition): string {
    ...
    if ((registry.total ?? 0) && registry.places != null) {
  ...
  protected compileTypeMultiPolygonZ(_column: ColumnDefinition): string {
    throw new Error(
      'This Database driver does not support the multipolygonz type.',
    );
  }
   ...
   */
  protected compileModifyAfter(
    _blueprint: BlueprintI,
    _column: ColumnDefinition,
  ): string {
    throw new Error(
      'this database driver does not support after column modifier.',
    );
  }
   ...
   */
  protected compileModifyCharset(
    _blueprint: BlueprintI,
    _column: ColumnDefinition,
  ): string {
    throw new Error(
      'this database driver does not support charset column modifier.',
    );
  }
  ...
  protected compileModifyCollate(
    ...
    throw new Error(
      'this database driver does not support collate column modifier.',
    );
  }
   ...
   */
  protected compileModifyComment(
    _blueprint: BlueprintI,
    _column: ColumnDefinition,
  ): string {
    throw new Error(
      'this database driver does not support comment column modifier.',
    );
  }
  ...
  protected compileModifyDefault(
    ...
    throw new Error(
      'this database driver does not support default column modifier.',
    );
  }
   ...
   */
  protected compileModifyFirst(
    _blueprint: BlueprintI,
    _column: ColumnDefinition,
  ): string {
    throw new Error(
      'this database driver does not support first column modifier.',
    );
  }
  ...
  protected compileModifyGeneratedAs(
    ...
    throw new Error(
      'this database driver does not support generated as column modifier.',
    );
  }
  ...
  protected compileModifyIncrement(
    ...
    throw new Error(
      'this database driver does not support increment column modifier.',
    );
  }
   ...
   */
  protected compileModifyInvisible(
    _blueprint: BlueprintI,
    _column: ColumnDefinition,
  ): string {
    throw new Error(
      'this database driver does not support invisible column modifier.',
    );
  }
  ...
  protected compileModifyNullable(
    ...
    throw new Error(
      'this database driver does not support nullable column modifier.',
    );
  }
   ...
   */
  protected compileModifyOnUpdate(
    _blueprint: BlueprintI,
    _column: ColumnDefinition,
  ): string {
    throw new Error(
      'this database driver does not support on update column modifier.',
    );
  }
   ...
   */
  protected compileModifyPersisted(
    _blueprint: BlueprintI,
    _column: ColumnDefinition,
  ): string {
    throw new Error(
      'this database driver does not support persisted column modifier.',
    );
  }
   ...
   */
  protected compileModifySrid(
    _blueprint: BlueprintI,
    _column: ColumnDefinition,
  ): string {
    throw new Error(
      'this database driver does not support srid column modifier.',
    );
  }
  ...
  protected compileModifyStoredAs(
    ...
    throw new Error(
      'this database driver does not support stored as column modifier.',
    );
  }
   ...
   */
  protected compileModifyUnsigned(
    _blueprint: BlueprintI,
    _column: ColumnDefinition,
  ): string {
    throw new Error(
      'this database driver does not support unsigned column modifier.',
    );
  }
  ...
  protected compileModifyVirtualAs(
    ...
    throw new Error(
      'this database driver does not support virtual as column modifier.',
    );
  }
   ...
   */
  public wrap(
    value: Stringable | CommandDefinition | ColumnDefinition,
  ): string {
    return super.wrap(
      value instanceof CommandDefinition || value instanceof ColumnDefinition
        ? value.name
        : value,
    );
  }
  ...
  protected getDefaultValue(
    value: Stringable | boolean | number | bigint,
  ): string {
