...
class Blueprint {
  ...
  public toSql(connection: ConnectionSessionI): string[] {
    ...
    for (const command of this.registry.commands) {
      ...
      switch (command.name) {
        ...
        case 'create':
          statements.push(
            this.grammar.compileCreate(this, command, connection),
          );
          break;
        case 'default':
          statements.push(
        ...
        case 'dropColumn':
          ...
          statements.push(
            ...(Array.isArray(dropcolumns) ? dropcolumns : [dropcolumns]),
          );
          break;
        case 'dropPrimary':
          statements.push(
            this.grammar.compileDropPrimary(
              this,
              command as CommandIndexDefinition,
              connection,
            ),
          );
          break;
        case 'dropUnique':
          statements.push(
            this.grammar.compileDropUnique(
              this,
              command as CommandIndexDefinition,
              connection,
            ),
        ...
        case 'dropFulltext':
          statements.push(
            this.grammar.compileDropFulltext(
              this,
              command as CommandIndexDefinition,
              connection,
            ),
        ...
        case 'dropSpatialIndex':
          statements.push(
            this.grammar.compileDropSpatialIndex(
              this,
              command as CommandIndexDefinition,
              connection,
            ),
        ...
        case 'dropForeign':
          statements.push(
            this.grammar.compileDropForeign(
              this,
              command as CommandForeignKeyDefinition,
              connection,
            ),
          );
          break;
        case 'dropTableIfExists':
          statements.push(
            this.grammar.compileDropTableIfExists(this, command, connection),
          );
          break;
        case 'primary':
          statements.push(
            this.grammar.compilePrimary(
              this,
              command as CommandIndexDefinition,
              connection,
            ),
        ...
        case 'spatialIndex':
          statements.push(
            this.grammar.compileSpatialIndex(
              this,
              command as CommandIndexDefinition,
              connection,
            ),
        ...
        case 'rename':
          statements.push(
            this.grammar.compileRename(
              this,
              command as CommandDefinition<RenameRegistryI>,
              connection,
            ),
          );
          break;
   ...
   */
  protected commandsNamed(
    names: string[],
  ): CommandDefinition<CommandRegistryI>[] {
    return this.registry.commands.filter((command) =>
      names.includes(command.name),
    );
  }
    ...
    loop1: for (const column of this.registry.columns) {
      ...
      for (const type of types) {
        ...
        if (value === true) {
          ...
          continue loop1;
        } else if (value === false && (column.getRegistry().change ?? false)) {
  ...
  public addCommands(): void {
    for (const column of this.registry.columns) {
      for (const command of this.grammar.getCommands()) {
        this.addCommand(
          this.createCommand<ColumnDefinitionRegistryI>(command, { column }),
        );
      }
    }
  }
  ...
  public creating(): boolean {
    return (
      this.registry.commands.find((command) => command.name === 'create') !==
      undefined
    );
  }
  ...
  public comment(comment: string): CommandDefinition<CommentRegistryI> {
    return this.addCommand(
      this.createCommand<CommentRegistryI>('tableComment', { comment }),
    );
  }
  ...
  public dropColumn(
    ...
    return this.addCommand(
      this.createCommand<ColumnsRegistryI>('dropColumn', { columns }),
    );
  }
  ...
  public renameColumn(
    from: Stringable,
    to: Stringable,
  ): CommandDefinition<RenameFullRegistryI> {
    return this.addCommand(
      this.createCommand<RenameFullRegistryI>('renameColumn', { from, to }),
    );
  }
  ...
  public dropFulltext(
    ...
    return this.addCommand(
      this.dropIndexCommand('dropFulltext', 'fulltext', index),
    );
  }
   ...
   */
  public dropSpatialIndex(
    index: Stringable | Stringable[],
  ): CommandIndexDefinition {
    return this.addCommand(
      this.dropIndexCommand('dropSpatialIndex', 'spatialIndex', index),
    );
  }
  ...
  public dropForeign(
    index: Stringable | Stringable[],
  ): CommandForeignKeyDefinition {
    return this.addCommand(
      this.dropForeignKeyCommand('dropForeign', 'foreign', index),
    );
  }
   ...
   * Indicate that the given foreign key should be dropped.
   */
  public dropForeignIdFor(
    model: RelatableConstructor | Relatable,
    column?: string,
  ): CommandForeignKeyDefinition {
   ...
   * Indicate that the given foreign key should be dropped.
   */
  public dropConstrainedForeignIdFor(
    model: RelatableConstructor | Relatable,
    column?: string,
  ): void {
    if (typeof model === 'function') {
    ...
    return this.dropConstrainedForeignId(
  ...
  public renameIndex(
    ...
    return this.addCommand(
      this.createCommand<RenameFullRegistryI>('renameIndex', { from, to }),
    );
  }
  ...
  public rename(to: Stringable): CommandDefinition<RenameRegistryI> {
    return this.addCommand(
      this.createCommand<RenameRegistryI>('rename', { to }),
    );
  }
  ...
  public primary(
    ...
    return this.addCommand(
      this.indexCommand('primary', columns, name, algorithm),
    );
  }
  ...
  public unique(
    ...
    return this.addCommand(
      this.indexCommand('unique', columns, name, algorithm),
    );
  }
  ...
  public index(
    ...
    return this.addCommand(
      this.indexCommand('index', columns, name, algorithm),
    );
  }
  ...
  public fulltext(
    ...
    return this.addCommand(
      this.indexCommand('fulltext', columns, name, algorithm),
    );
  }
  ...
  public foreign(
    ...
    const command = this.addCommand(
      this.foreignKeyCommand('foreign', columns, name),
    );
  ...
  public char(column: Stringable, length?: number): ColumnDefinition {
    return this.addColumn('char', column, {
      length: length ?? QueryBuilder.defaultStringLength,
    });
  }
  ...
  public foreignId(column: Stringable): ForeignIdColumnDefinition {
    const definition = new ForeignIdColumnDefinition(
      this,
      'bigInteger',
      column,
      {
  ...
  public foreignUuid(column: Stringable): ForeignIdColumnDefinition {
    return this.addColumnDefinition(
      new ForeignIdColumnDefinition(this, 'uuid', column),
    );
  }
  ...
  public foreignUlid(
    ...
    return this.addColumnDefinition(
      new ForeignIdColumnDefinition(this, 'char', column, { length }),
    );
  }
   ...
   */
  protected createForeignCommand<
    T extends ForeignKeyRegistryI = ForeignKeyRegistryI,
  >(name: CommandType, parameters: T): CommandForeignKeyDefinition<T> {
  ...
  protected foreignKeyCommand(
    ...
    return this.createForeignCommand(type, {
      on: '',
      references: '',
      index,
      columns,
   ...
   */
  protected addColumnDefinition<T extends ColumnDefinition = ColumnDefinition>(
    definition: T,
  ): T {
    this.registry.columns.push(definition);

    if (isStringable(this.registry.after)) {
  ...
  public removeColumn(name: Stringable): this {
    this.registry.columns = this.registry.columns.filter(
      (definition) =>
        this.grammar.getValue(definition.name).toString() !==
        this.grammar.getValue(name).toString(),
    );
   ...
   */
  protected addCommand<T extends CommandDefinition = CommandDefinition>(
    command: T,
  ): T {
  ...
  public getAddedColumns(): ColumnDefinition[] {
    return this.registry.columns.filter(
      (definition) => !Boolean(definition.getRegistry().change),
    );
  }
  ...
  public getChangedColumns(): ColumnDefinition[] {
    return this.registry.columns.filter((definition) =>
      Boolean(definition.getRegistry().change),
    );
  }
}
