...
export type ViewCallback = (
  definition: CommandViewDefinition<ViewRegistryI>,
) => CommandViewDefinition<ViewRegistryI>;
...
export default interface SchemaBuilderI<
  Session extends ConnectionSessionI<DriverConnectionI>,
> {
  /**
