...
import QueryBuilderI, { NumericValues, QueryAbleCallback, RowValues } from './query-builder';
import RegistryI, { BindingTypes } from './registry';

export default interface BuilderI extends QueryBuilderI {
    /**
     ...
     */
    insertUsing(columns: Stringable[], query: QueryAbleCallback<BuilderI> | BuilderI | Stringable): Promise<number>;
