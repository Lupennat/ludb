...
import RegistryI, { BindingTypes, CteCycle, Where } from './registry';

export type GrammarBuilderConstructor<T extends GrammarBuilderI> = new (connection: ConnectionSessionI) => T;

export type BooleanCallback<T, U extends GrammarBuilderI> = (query: U) => T;

export type ConditionalCallback<T extends GrammarBuilderI, U> = (query: T, value: U) => void | T;

export type QueryAbleCallback<T extends GrammarBuilderI> = (query: T) => void;

export type SelectColumn<T extends GrammarBuilderI> =
    | Stringable
    | { [key: string]: GrammarBuilderI | QueryAbleCallback<T> };
...
export default interface GrammarBuilderI<
...
> {
     ...
     */
    selectSub(query: QueryAbleCallback<this> | GrammarBuilderI | Stringable, as: Stringable): this;
     ...
     */
    fromSub(query: QueryAbleCallback<this> | GrammarBuilderI | Stringable, as: Stringable): this;
     ...
     */
    from(table: QueryAbleCallback<this> | GrammarBuilderI | Stringable, as?: string): this;
     ...
     */
    crossJoinSub(query: QueryAbleCallback<this> | GrammarBuilderI | Stringable, as: Stringable): this;
     ...
     */
    withRecursiveExpressionAndCycleDetection(
        name: Stringable,
        query: QueryAbleCallback<this> | GrammarBuilderI | Stringable,
    ...
    whereNot(column: Stringable, operator: string, value: Binding | QueryAbleCallback<this> | GrammarBuilderI): this;
    whereNot(
        column: QueryAbleCallback<this> | GrammarBuilderI,
        operator: string,
        value: BindingExclude<null> | QueryAbleCallback<this> | GrammarBuilderI
    ...
    orWhereNot(column: Stringable, operator: string, value: Binding | QueryAbleCallback<this> | GrammarBuilderI): this;
    orWhereNot(
        column: QueryAbleCallback<this> | GrammarBuilderI,
        operator: string,
        value: BindingExclude<null> | QueryAbleCallback<this> | GrammarBuilderI
     ...
     */
    addNestedWhereQuery(query: GrammarBuilderI, boolean?: ConditionBoolean, not?: boolean): this;

    /**
     * Add an exists clause to the query.
     */
    whereExists(callback: GrammarBuilderI | QueryAbleCallback<this>, boolean?: ConditionBoolean, not?: boolean): this;

    /**
     * Add an or exists clause to the query.
     */
    orWhereExists(callback: GrammarBuilderI | QueryAbleCallback<this>, not?: boolean): this;

    /**
     * Add a where not exists clause to the query.
     */
    whereNotExists(callback: GrammarBuilderI | QueryAbleCallback<this>, boolean?: ConditionBoolean): this;

    /**
     * Add a where not exists clause to the query.
     */
    orWhereNotExists(callback: GrammarBuilderI | QueryAbleCallback<this>): this;

    /**
     * Add an exists clause to the query.
     */
    addWhereExistsQuery(query: GrammarBuilderI, boolean?: ConditionBoolean, not?: boolean): this;
     ...
     */
    addNestedHavingQuery(query: GrammarBuilderI, boolean?: ConditionBoolean, not?: boolean): this;
     ...
     */
    orderBy(column: QueryAbleCallback<this> | GrammarBuilderI | Stringable, direction?: OrderDirection): this;

    /**
     * Add a descending "order by" clause to the query.
     */
    orderByDesc(column: QueryAbleCallback<this> | GrammarBuilderI | Stringable): this;

    /**
     * Add an "order by" clause for a timestamp to the query.
     */
    latest(column?: QueryAbleCallback<this> | GrammarBuilderI | Stringable): this;

    /**
     * Add an "order by" clause for a timestamp to the query.
     */
    oldest(column?: QueryAbleCallback<this> | GrammarBuilderI | Stringable): this;
     ...
     */
    recursionLimit(value?: number | null): this;
     ...
     */
    reorder(column?: QueryAbleCallback<this> | GrammarBuilderI | Stringable | null, direction?: OrderDirection): this;

    /**
     * Add a union statement to the query.
     */
    union(query: QueryAbleCallback<this> | GrammarBuilderI, all?: boolean): this;

    /**
     * Add a union all statement to the query.
     */
    unionAll(query: QueryAbleCallback<this> | GrammarBuilderI): this;
     ...
     */
    mergeBindings(query: GrammarBuilderI): this;
     ...
     */
    forNestedWhere(): GrammarBuilderI;

    /**
     * Get a new instance of the query builder.
     */
    newQuery(): GrammarBuilderI;

    /**
     * Clone the query.
     */
    clone(): GrammarBuilderI;

    /**
     * Clone the query without the given registry properties.
     */
    cloneWithout(properties: (keyof RegistryI)[]): GrammarBuilderI;

    /**
     * Clone the query without the given bindings.
     */
    cloneWithoutBindings(except: (keyof BindingTypes)[]): GrammarBuilderI;
}
