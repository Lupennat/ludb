...
export type GrammarBuilderConstructor<T extends GrammarBuilderI> = new (
  connection: ConnectionSessionI,
) => T;

export type BooleanCallback<T, U extends GrammarBuilderI> = (query: U) => T;

export type ConditionalCallback<T extends GrammarBuilderI, U> = (
  query: T,
  value: U,
) => void | T;
...
export type WhereColumnTuple =
  | [Stringable, Stringable]
  | [Stringable, string, Stringable];

export type BetweenTuple = [
  Stringable | number | bigint | Date,
  Stringable | number | bigint | Date,
];
...
> {
   ...
   */
  reorder(
    column?: QueryAbleCallback<this> | GrammarBuilderI | Stringable | null,
    direction?: OrderDirection,
  ): this;
