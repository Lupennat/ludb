...
import {
  ISOLATION_LEVEL,
  LupdoSqlserverOptions,
} from './lupdo-drivers/sqlserver';
...
export interface MysqlReadAndWriteOptions
  extends ReadAndWriteConnectionOptions<MysqlConnectionOptions> {}
...
export interface SqliteReadAndWriteOptions
  extends ReadAndWriteConnectionOptions<SqliteConnectionOptions> {}
...
export interface PostgresReadAndWriteOptions
  extends ReadAndWriteConnectionOptions<PostgresConnectionOptions> {}
...
export interface SqlserverReadAndWriteOptions
  extends ReadAndWriteConnectionOptions<SqlserverConnectionOptions> {}
...
export type ReadAndWriteConnectionOptions<T> = Omit<
  T,
  'database' | 'prefix' | 'prefix_index' | 'attributes'
>;
