  ...
  implements JoinClauseI
{
  ...
  constructor(
    ...
    this.parentClass =
      parentQuery.constructor as GrammarBuilderConstructor<Parent>;
  }
  ...
  protected newJoinClause<T extends GrammarBuilderI>(
    ...
    return new (this.constructor as JoinClauseConstructor<T>)(
      parentQuery,
      type,
      table,
    );
  ...
  public newQuery(): JoinClauseI {
    return new (this.constructor as JoinClauseConstructor<Parent>)(
      this.newParentQuery(),
      this.type,
      this.table,
    );
