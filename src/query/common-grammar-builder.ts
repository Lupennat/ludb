...
abstract class CommonGrammarBuilder<
  SessionConnection extends
    ConnectionSessionI<DriverConnectionI> = ConnectionSessionI<DriverConnectionI>,
> implements GrammarBuilderI<SessionConnection>
{
   ...
   */
  public cloneRegistryWithoutProperties(
    properties: (keyof RegistryI)[],
  ): RegistryI {
  ...
  public select(
    ...
    columns = (Array.isArray(columns) ? columns : [columns]).concat(
      otherColumns,
    );
  ...
  public selectSub(
    ...
    return this.selectRaw(
      `(${queryString}) as ${this.getGrammar().wrap(as)}`,
      bindings,
    );
  }
  ...
  public fromSub(
    ...
    return this.fromRaw(
      `(${queryString}) as ${this.getGrammar().wrapTable(as)}`,
      bindings,
    );
  }
   ...
   */
  public fromRaw(
    expression: string | Stringable,
    bindings: Binding[] = [],
  ): this {
    this.registry.from = isExpression(expression)
      ? expression
      : this.raw(expression);
  ...
  protected prependDatabaseNameIfCrossDatabaseQuery(
    ...
    if (
      ...
      const queryFrom = query
        .getGrammar()
        .getValue(query.getRegistry().from)
        .toString();
  ...
  public withExpression(
    ...
    const [queryString, bindings] = this.createSub(query);
    this.registry[
      this.registry.unions.length > 0 ? 'unionExpressions' : 'expressions'
    ].push({
      name,
      query: queryString,
      columns,
   ...
   */
  public distinct(
    column?: boolean | Stringable,
    ...columns: Stringable[]
  ): this {
    if (column != null) {
      this.registry.distinct =
        typeof column === 'boolean' ? column : [column].concat(columns);
    } else {
   ...
   */
  public from(
    table: QueryAbleCallback<this> | GrammarBuilderI | Stringable,
    as = '',
  ): this {
    ...
    this.registry.from = as
      ? `${this.getGrammar().getValue(table).toString()} as ${as}`
      : table;
  ...
  public join(
    ...
    return this.joinImplementation(
      table,
      first,
      operatorOrSecond,
      second,
   ...
   */
  protected baseJoin<T>(
    type: string,
    table: Stringable,
    first: T,
    callback: (join: JoinClauseI) => void,
  ): this {
  ...
  public joinWhere(
    ...
    return this.joinWhereImplementation(
      table,
      first,
      operatorOrSecond,
      second,
  ...
  public joinSub(
    ...
    return this.joinSubImplementation(
      query,
      as,
      first,
      operatorOrSecond,
  ...
  public joinWhereSub(
    ...
    return this.joinWhereSubImplementation(
      query,
      as,
      first,
      operatorOrSecond,
  ...
  public crossJoinSub(
    ...
    this.registry.joins.push(
      this.newJoinClause(this, 'cross', this.raw(expression)),
    );
  ...
  public mergeWheres(wheres: Where[], bindings: Binding[]): this {
    ...
    this.registry.bindings.where =
      this.registry.bindings.where.concat(bindings);
  ...
  protected whereImplementation(
    ...
    let [val, operator] = this.prepareValueAndOperator(
      value,
      operatorOrValue,
      arguments.length === 2,
    );
    ...
    [val, operator] = this.assignValueAndOperator(
      value,
      operatorOrValue,
      arguments.length === 2,
    );
    ...
    if (this.isQueryable(column)) {
      ...
      return this.addBinding(bindings, 'where').whereImplementation(
        this.raw(`(${sub})`),
        operator,
        val,
        boolean,
   ...
   */
  protected assignValueAndOperator<T>(
    value: T,
    operator: string | T,
    useDefault: boolean,
  ): [T, string] {
   ...
   */
  protected isValidOperatorAndValue<T>(
    operator: string | T,
    value: T,
  ): operator is string {
    return (
      typeof operator === 'string' &&
      (value !== null || ['=', '<>', '!='].includes(operator))
    );
  }
   ...
   */
  protected isBitwiseOperator(
    operator: Stringable | Binding,
  ): operator is string {
    return (
      typeof operator === 'string' &&
  ...
  public where(
    column: QueryAbleCallback<this> | WhereTuple[] | WhereObject,
  ): this;
  public where(
    column: Stringable,
  ...
  public where(
    ...
    operatorOrValue:
      ...
      | Binding
      | QueryAbleCallback<this>
      | GrammarBuilderI = null,
    value: Binding | QueryAbleCallback<this> | GrammarBuilderI = null,
  ): this {
    [value, operatorOrValue] = this.prepareValueAndOperator(
      value,
      operatorOrValue,
      arguments.length === 2,
    );
  ...
  public whereNot(
    ...
    return this.whereImplementation(
      column,
      operatorOrValue,
      value,
      'and',
  ...
  public orWhereColumn(
    ...
    return this.whereColumnImplementation(
      first,
      operatorOrSecond,
      second,
      'or',
  ...
  public whereIntegerInRaw(
    ...
    this.registry.wheres.push({
      type,
      column,
      values: (isArrayable<Binding>(values) ? values.toArray() : values).map(
        (value: any): bigint => {
          try {
            return BigInt(value);
          } catch (error) {
  ...
  public whereBetween(
    ...
    this.addBinding(
      this.cleanBindings(values.flat(Infinity)).slice(0, 2),
      'where',
    );
  ...
  protected whereDateImplementation(
    ...
    [value, operatorOrValue] = this.assignValueAndOperator(
      value,
      operatorOrValue,
      arguments.length === 2,
    );
    ...
    if (value instanceof Date) {
      value = `${value.getFullYear().toString().padStart(4, '0')}-${(
        value.getMonth() + 1
      )
        .toString()
  ...
  public whereDateNot(
    ...
    return this.whereDateImplementation(
      column,
      operatorOrValue,
      value,
      'and',
  ...
  public whereTimeNot(
    ...
    return this.whereTimeImplementation(
      column,
      operatorOrValue,
      value,
      'and',
  ...
  public whereDayNot(
    ...
    return this.whereDayImplementation(
      column,
      operatorOrValue,
      value,
      'and',
  ...
  public whereMonthNot(
    ...
    return this.whereMonthImplementation(
      column,
      operatorOrValue,
      value,
      'and',
  ...
  public whereYearNot(
    ...
    return this.whereYearImplementation(
      column,
      operatorOrValue,
      value,
      'and',
   ...
   */
  public orWhereJsonDoesntContain(
    column: Stringable,
    value: Binding[] | Binding,
  ): this {
  ...
  public whereJsonLength(
    ...
    [value, operator] = this.assignValueAndOperator(
      value,
      operator,
      arguments.length === 2,
    );
  ...
  public havingNot(
    ...
    return this.havingImplementation(
      column,
      operatorOrValue,
      value,
      'and',
  ...
  public orderBy(
    ...
    if (this.isQueryable(column)) {
      ...
      this.addBinding(
        bindings,
        this.registry.unions.length > 0 ? 'unionOrder' : 'order',
      );
    }
    ...
    this.registry[
      this.registry.unions.length > 0 ? 'unionOrders' : 'orders'
    ].push({
      column: column,
      direction: direction,
    });
  ...
  public recursionLimit(value: number | null = null): this {
    this.registry[
      this.registry.unions.length > 0 ? 'unionRecursionLimit' : 'recursionLimit'
    ] = value == null || value < 0 ? null : value;
   ...
   */
  public union(
    query: GrammarBuilderI | QueryAbleCallback<this>,
    all = false,
  ): this {
    let realQuery;
    if (this.isQueryableCallback(query)) {
  ...
  public getColumns(): string[] {
    ...
    return columns !== null
      ? columns.map((column) => this.getGrammar().getValue(column).toString())
      : [];
  }
  ...
  public setBindings(
    bindings: Binding[],
    type: keyof BindingTypes = 'where',
  ): this {
    if (!(type in this.registry.bindings)) {
      throw new Error(`Invalid binding type: ${type}.`);
    }

    this.registry.bindings[type] = bindings.map((binding) =>
  ...
  public addBinding(
    ...
    this.registry.bindings[type].push(
      ...value.map((binding) => this.castBinding(binding)),
    );
  ...
  public mergeBindings(query: GrammarBuilderI): this {
    this.registry.bindings = merge(
      this.registry.bindings,
      query.getRegistry().bindings,
    );
  ...
  public cleanBindings(bindings: any[]): BindingExclude<ExpressionContract>[] {
    return bindings
      ...
      .map((binding: any) =>
        this.castBinding(binding),
      ) as BindingExclude<ExpressionContract>[];
  }
   ...
   */
  public getGrammar(): ReturnType<
    ReturnType<this['getConnection']>['getQueryGrammar']
  > {
    return this.connection.getQueryGrammar() as ReturnType<
      ReturnType<this['getConnection']>['getQueryGrammar']
    >;
  }
  ...
  protected isQueryable<
    T extends GrammarBuilderI = this,
    U extends GrammarBuilderI = GrammarBuilderI,
  >(value: any): value is U | QueryAbleCallback<T> {
    return (
      this.isQueryableCallback<T>(value) || this.isGrammarBuilder<U>(value)
    );
  }
   ...
   */
  protected isGrammarBuilder<T extends GrammarBuilderI = GrammarBuilderI>(
    value: any,
  ): value is T {
   ...
   */
  protected isQueryableCallback<T extends GrammarBuilderI = this>(
    value: any,
  ): value is QueryAbleCallback<T> {
   ...
   * Determine if the value is instance or a Closure.
   */
  protected isBooleanCallback<T, U extends GrammarBuilderI = this>(
    value: any,
  ): value is BooleanCallback<T, U> {
    return typeof value === 'function';
  }
  ...
  protected isWhereObject(parameter: any): parameter is WhereObject {
    return (
      ...
      !this.isGrammarBuilder(parameter) &&
      !isExpression(parameter)
    );
  }
   ...
   */
  public newQuery(): any {
    return new (this.constructor as GrammarBuilderConstructor<this>)(
      this.getConnection(),
    );
  }
  ...
  public clone(): any {
    return this.cloneBeforeQueryCallbacks(
      this.newQuery().setRegistry(this.cloneRegistry()),
    );
  }
  ...
  public cloneWithout(properties: (keyof RegistryI)[]): any {
    return this.cloneBeforeQueryCallbacks(
      this.newQuery().setRegistry(
        this.cloneRegistryWithoutProperties(properties),
      ),
    );
  }
  ...
  public cloneWithoutBindings(except: (keyof BindingTypes)[]): any {
    return this.cloneBeforeQueryCallbacks(
      this.newQuery().setRegistry(this.cloneRegistryWithoutBindings(except)),
    );
  }
  ...
  protected cloneBeforeQueryCallbacks(cloned: any): any {
    this.beforeQueryCallbacks
      .slice()
      .forEach((callback) => cloned.beforeQuery(callback));
