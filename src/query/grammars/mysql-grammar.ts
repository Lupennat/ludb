...
import { Cte, whereFulltext, WhereNull } from '../../types/query/registry';
...
class MysqlGrammar extends Grammar {
  ...
  public compileFulltext(
    ...
    const expanded =
      (where.options.expanded ?? false) && where.options.mode !== 'boolean'
  ...
  public compileUpsert(
    ...
    const useUpsertAlias = query
      .getConnection()
      .getConfig<boolean>('use_upsert_alias', false);
