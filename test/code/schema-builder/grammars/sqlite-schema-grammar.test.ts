...
describe('Sqlite Schema Grammar', () => {
  ...
  it('Works Adding Foreign Id Specifying Index Name In Constraint', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "company_id" integer not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding String', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" varchar default \'bar\'').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Float', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" float not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Decimal', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" numeric not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Boolean', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" tinyint(1) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Time', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "created_at" time not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding SoftDeletes Datetime', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect(['alter table "users" add column "deleted_at" datetime']).toEqual(
      statements,
    );
  });
  ...
  it('Works Adding Binary', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" blob not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Uuid Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "uuid" varchar not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ulid Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "ulid" varchar not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ip Address Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "ip_address" varchar not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Mac Address Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table "users" add column "mac_address" varchar not null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Geometry', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "geo" add column "coordinates" geometry not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Point', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "geo" add column "coordinates" point not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Polygon', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "geo" add column "coordinates" polygon not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Create Table With Virtual As Column', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'create table "users" ("my_column" varchar not null, "my_other_column" varchar as (my_column))',
    ).toBe(statements[0]);
