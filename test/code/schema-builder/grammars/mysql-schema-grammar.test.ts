...
import QueryBuilder from '../../../../src//schema/builders/builder';
import ForeignIdColumnDefinition from '../../../../src//schema/definitions/foreign-id-column-definition';
import MysqlSchemaGrammar from '../../../../src//schema/grammars/mysql-grammar';
...
describe('Mysql Schema Grammar', () => {
  ...
  it('Works Drop Full Text', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` drop index `users_foo_fulltext`').toBe(
      statements[0],
    );
  });
  ...
  it('Works Drop Spatial Index', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `geo` drop index `geo_coordinates_spatialindex`').toBe(
      statements[0],
    );
  });
  ...
  it('Works Drop Timestamps', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` drop `created_at`, drop `updated_at`').toBe(
      statements[0],
    );
  });
  ...
  it('Works Drop Morphs', () => {
    ...
    expect(
      'alter table `photos` drop `imageable_type`, drop `imageable_id`',
    ).toBe(statements[1]);
  });
  ...
  it('Works Rename Index', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` rename index `foo` to `bar`').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Primary Key With Algorithm', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add primary key using hash(`foo`)').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Fluent Unique Key', () => {
    ...
    expect(2).toBe(statements.length);
    expect('alter table `users` add unique `users_baz_unique`(`baz`)').toBe(
      statements[1],
    );
  });
  ...
  it('Works Adding Index', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add index `baz`(`foo`, `bar`)').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Fluent Index', () => {
    ...
    expect(2).toBe(statements.length);
    expect('alter table `users` add index `users_baz_index`(`baz`)').toBe(
      statements[1],
    );
  });
  ...
  it('Works Adding Index With Algorithm', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add index `baz` using hash(`foo`, `bar`)').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Fulltext Index', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add fulltext `users_body_fulltext`(`body`)',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Fluent Fulltext Index', () => {
    ...
    expect(2).toBe(statements.length);
    expect('alter table `users` add fulltext `users_baz_fulltext`(`baz`)').toBe(
      statements[1],
    );
  });
  ...
  it('Works Adding Fluent Spatial Index', () => {
    ...
    expect(2).toBe(statements.length);
    expect('alter table `geo` add spatial index `bar`(`coordinates`)').toBe(
      statements[1],
    );
  ...
  it('Works Adding Raw Index', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add index `raw_index`((function(column)))',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Foreign Id Specifying Index Name In Constraint', () => {
    ...
    blueprint
      ...
      .constrained(undefined, undefined, 'my_index');
    const statements = blueprint.toSql(connection);
  ...
  it('Works Adding Column In Table First', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `name` varchar(255) not null first').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Generated Column', () => {
    ...
    blueprint.integer('price');
    blueprint
      .integer('discounted_virtual')
      .virtualAs('price - 5')
      .nullable(false);
    blueprint
      .integer('discounted_stored')
      .storedAs('price - 5')
      .nullable(false);
    statements = blueprint.toSql(connection);
  ...
  it('Works Adding Generated Column With Charset', () => {
    ...
    blueprint
      .string('url_hash_virtual', 64)
      .virtualAs('sha2(url, 256)')
      .charset('ascii');
    blueprint
      .string('url_hash_stored', 64)
  ...
  it('Works Adding Invisible Column', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add `secret` varchar(64) not null invisible',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Char Without Length Limit', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` char(255) not null').toBe(
      statements[0],
    );
  ...
  it('Works Adding String', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` varchar(255) not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` varchar(100) not null').toBe(
      statements[0],
    );
  ...
  it('Works Adding String Without Length Limit', () => {
    ...
    try {
      expect(1).toBe(statements.length);
      expect('alter table `users` add `foo` varchar not null').toBe(
        statements[0],
      );
    } finally {
      QueryBuilder.withDefaultStringLength(255);
  ...
  it('Works Adding Medium Text', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` mediumtext not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Long Text', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` longtext not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Integer', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` int unsigned not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Medium Integer', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` mediumint not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` mediumint unsigned not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Small Integer', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` smallint not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` smallint unsigned not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Tiny Integer', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` tinyint not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` tinyint unsigned not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Float', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` double(5, 2) not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` double(8, 2) not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` double(5, 2) unsigned not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` double(8, 2) unsigned not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Double', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` double unsigned not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Double Specifying Precision', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` double(15, 8) not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add `foo` double(15, 8) unsigned not null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Decimal', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` decimal(8, 2) not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` decimal(5, 2) not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add `foo` decimal(8, 2) unsigned not null',
    ).toBe(statements[0]);
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add `foo` decimal(5, 2) unsigned not null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Boolean', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` tinyint(1) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Year', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table `users` add `birth_year` year not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Date Time', () => {
    ...
    let statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` datetime not null').toBe(
      statements[0],
    );
    ...
    statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` datetime(0) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Date Time With Default Current', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add `foo` datetime(0) not null default CURRENT_TIMESTAMP',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Date Time With On Update Current', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add `foo` datetime(0) not null on update CURRENT_TIMESTAMP',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Time', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table `users` add `created_at` time not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Time With Precision', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table `users` add `created_at` time(0) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Timestamp', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table `users` add `created_at` timestamp not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Timestamp With Precision', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table `users` add `created_at` timestamp(0) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Timestamp With On Update Current Specifying Precision', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add `created_at` timestamp(1) not null on update CURRENT_TIMESTAMP(1)',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Time Stamp Tz With Default', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      "alter table `users` add `created_at` timestamp(0) not null default '2015-07-22 11:43:17'",
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Datetimes', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add `created_at` datetime(0) null, add `updated_at` datetime(0) null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Timestamps', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `users` add `created_at` timestamp(0) null, add `updated_at` timestamp(0) null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding SoftDeletes Datetime', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table `users` add `column` datetime(0) null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding softDeletes', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table `users` add `deleted_at` timestamp(0) null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Uuid', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` char(36) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Uuid Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `uuid` char(36) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ulid', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` char(26) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ulid Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `ulid` char(26) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ip Address', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` varchar(45) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ip Address Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `ip_address` varchar(45) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Mac Address', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `foo` varchar(17) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Mac Address Defaults ColumnName', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `users` add `mac_address` varchar(17) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Geometry', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `geo` add `coordinates` geometry not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Point', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `geo` add `coordinates` point not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Point With Srid', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `geo` add `coordinates` point not null srid 4326').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Line String', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `geo` add `coordinates` linestring not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Polygon', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `geo` add `coordinates` polygon not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Geometry Collection', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table `geo` add `coordinates` geometrycollection not null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Multi Point', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `geo` add `coordinates` multipoint not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Multi Line String', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `geo` add `coordinates` multilinestring not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Multi Polygon', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table `geo` add `coordinates` multipolygon not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Create Database', () => {
    ...
    let statement = new MysqlSchemaGrammar().compileCreateDatabase(
      'my_database_a',
      connection,
    );
    ...
    statement = new MysqlSchemaGrammar().compileCreateDatabase(
      'my_database_b',
      connection,
    );
  ...
  it('Works Create Table With Virtual As Column', () => {
    ...
    blueprint
      .string('my_other_column')
      .virtualAs('my_json_column->some_attribute');
    ...
    blueprint
      .string('my_other_column')
      .virtualAs('my_json_column->some_attribute->nested');
  ...
  it('Works Create Table With Stored As Column', () => {
    ...
    blueprint
      .string('my_other_column')
      .storedAs('my_json_column->some_attribute');
    ...
    blueprint
      .string('my_other_column')
      .storedAs('my_json_column->some_attribute->nested');
  ...
  it('Works Drop Database If Exists', () => {
    let statement = new MysqlSchemaGrammar().compileDropDatabaseIfExists(
      'my_database_a',
    );
  ...
  it('Works Drop Tables', () => {
    const statement = new MysqlSchemaGrammar().compileDropTables([
      'alpha',
      'beta',
      'gamma',
    ]);
  ...
  it('Works Drop Views', () => {
    const statement = new MysqlSchemaGrammar().compileDropViews([
      'alpha',
      'beta',
      'gamma',
    ]);
