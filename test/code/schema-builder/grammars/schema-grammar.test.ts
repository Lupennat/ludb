...
import CommandDefinition from '../../../../src//schema/definitions/commands/command-definition';
import CommandForeignKeyDefinition from '../../../../src//schema/definitions/commands/command-foreign-key-definition';
import CommandIndexDefinition from '../../../../src//schema/definitions/commands/command-index-definition';
import Grammar from '../../../../src//schema/grammars/grammar';
import {
  ...
  RenameFullRegistryI,
  RenameRegistryI,
} from '../../../../src//types/schema/registry';
import {
  getConnection,
  getMysqlBlueprint,
  MockedGrammar,
...
describe('Mysql Schema Grammar', () => {
  ...
  it('Works Compile Modify After', () => {
    ...
    expect(() => {
      grammar.compileModifyAfter(
        getMysqlBlueprint('test'),
        new ColumnDefinition('string', 'test', {}),
      );
  ...
  it('Works Compile Modify GeneratedAs', () => {
    const grammar = new MockedGrammar();
    expect(() => {
      grammar.compileModifyGeneratedAs(
        getMysqlBlueprint('test'),
        new ColumnDefinition('string', 'test', {}),
      );
    }).toThrow(
  ...
  it('Works Compile Modify Increment', () => {
    const grammar = new MockedGrammar();
    expect(() => {
      grammar.compileModifyIncrement(
        getMysqlBlueprint('test'),
        new ColumnDefinition('string', 'test', {}),
      );
    }).toThrow(
  ...
  it('Works Compile Modify Invisible', () => {
    const grammar = new MockedGrammar();
    expect(() => {
      grammar.compileModifyInvisible(
        getMysqlBlueprint('test'),
        new ColumnDefinition('string', 'test', {}),
      );
    }).toThrow(
  ...
  it('Works Compile Modify Persisted', () => {
    const grammar = new MockedGrammar();
    expect(() => {
      grammar.compileModifyPersisted(
        getMysqlBlueprint('test'),
        new ColumnDefinition('string', 'test', {}),
      );
    }).toThrow(
  ...
  it('Works Compile Modify VirtualAs', () => {
    const grammar = new MockedGrammar();
    expect(() => {
      grammar.compileModifyVirtualAs(
        getMysqlBlueprint('test'),
        new ColumnDefinition('string', 'test', {}),
      );
    }).toThrow(
