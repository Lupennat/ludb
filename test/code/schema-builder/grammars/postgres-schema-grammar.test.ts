...
import PostgresSchemaGrammar from '../../../../src//schema/grammars/postgres-grammar';
import {
...
describe('Posgtres Schema Grammar', () => {
  ...
  it('Works Create Table And Comment Column', () => {
    ...
    expect('comment on column "users"."email" is \'my first comment\'').toBe(
      statements[1],
    );
  });
  ...
  it('Works Drop Column', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" drop column "foo", drop column "bar"').toBe(
      statements[0],
    );
  ...
  it('Works Drop Primary', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" drop constraint "users_pkey"').toBe(
      statements[0],
    );
  });
  ...
  it('Works Drop Morphs', () => {
    ...
    expect(2).toBe(statements.length);
    expect('drop index "photos_imageable_type_imageable_id_index"').toBe(
      statements[0],
    );
    expect(
  ...
  it('Works Adding Unique Key', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add constraint "bar" unique ("foo")').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Index With Algorithm', () => {
    ...
    expect(1).toBe(statements.length);
    expect('create index "baz" on "users" using hash ("foo", "bar")').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Fulltext Index With Language', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'create index "users_body_fulltext" on "users" using gin ((to_tsvector(\'spanish\', "body")))',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Raw Index', () => {
    ...
    expect(1).toBe(statements.length);
    expect('create index "raw_index" on "users" ((function(column)))').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Foreign Id Specifying Index Name In Constraint', () => {
    ...
    expect(2).toBe(statements.length);
    expect('alter table "users" add column "company_id" bigint not null').toBe(
      statements[0],
    );
    expect(
  ...
  it('Works Adding String', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" varchar(255) not null').toBe(
      statements[0],
    );
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" varchar(100) not null').toBe(
      statements[0],
    );
  ...
  it('Works Column Modifying', () => {
    ...
    blueprint = getPostgresBlueprint('users', (table) => {
      table
        .timestamp('added_at', 2)
        .useCurrent()
        .virtualAs('foo is not null')
        .change();
    });
  ...
  it('Works Adding String Without Length Limit', () => {
    ...
    try {
      expect(1).toBe(statements.length);
      expect('alter table "users" add column "foo" varchar not null').toBe(
        statements[0],
      );
    } finally {
  ...
  it('Works Adding Char Without Length Limit', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" char(255) not null').toBe(
      statements[0],
    );
    ...
    try {
      expect(1).toBe(statements.length);
      expect('alter table "users" add column "foo" char not null').toBe(
        statements[0],
      );
    } finally {
      QueryBuilder.withDefaultStringLength(255);
  ...
  it('Works Adding Text', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" text not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Big Integer', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" bigint not null').toBe(
      statements[0],
    );
  ...
  it('Works Adding Integer', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" integer not null').toBe(
      statements[0],
    );
  ...
  it('Works Adding Tiny Integer', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" smallint not null').toBe(
      statements[0],
    );
  ...
  it('Works Adding Decimal', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" decimal(5, 2) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Boolean', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" boolean not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Date', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" date not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Year', () => {
    ...
    const statements = blueprint.toSql(connection);
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "birth_year" integer not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Json', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" json not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Jsonb', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" jsonb not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding SoftDeletes', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table "users" add column "column" timestamp(0) without time zone null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding SoftDeletes Tz', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table "users" add column "column" timestamp(0) with time zone null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Binary', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" bytea not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Uuid', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" uuid not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Uuid Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "uuid" uuid not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ulid', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" char(26) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ulid Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "ulid" char(26) not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ip Address', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" inet not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Ip Address Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "ip_address" inet not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Mac Address', () => {
    ...
    expect(1).toBe(statements.length);
    expect('alter table "users" add column "foo" macaddr not null').toBe(
      statements[0],
    );
  });
  ...
  it('Works Adding Mac Address Defaults Column Name', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table "users" add column "mac_address" macaddr not null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Compile Unique', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table "users" add constraint "users_key_unique" unique ("key") deferrable',
    ).toBe(statements[0]);
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table "users" add constraint "users_key_unique" unique ("key") not deferrable',
    ).toBe(statements[0]);
  ...
  it('Works Adding Multi Point', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table "geo" add column "coordinates" geometry(multipoint) not null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Adding Multi PolygonZ', () => {
    ...
    expect(1).toBe(statements.length);
    expect(
      'alter table "geo" add column "coordinates" geography(multipolygonz, 4326) not null',
    ).toBe(statements[0]);
  });
  ...
  it('Works Create Database', () => {
    ...
    let statement = new PostgresSchemaGrammar().compileCreateDatabase(
      'my_database_a',
      connection,
    );

    expect('create database "my_database_a" encoding "utf8_foo"').toBe(
      statement,
    );
    ...
    statement = new PostgresSchemaGrammar().compileCreateDatabase(
      'my_database_b',
      connection,
    );

    expect('create database "my_database_b" encoding "utf8_bar"').toBe(
      statement,
    );
  });

  it('Works Drop Database If Exists', () => {
    let statement = new PostgresSchemaGrammar().compileDropDatabaseIfExists(
      'my_database_a',
    );

    expect('drop database if exists "my_database_a"').toBe(statement);

    statement = new PostgresSchemaGrammar().compileDropDatabaseIfExists(
      'my_database_b',
    );
  ...
  it('Works Drop Tables Escapes Table Names', () => {
    const statement = new PostgresSchemaGrammar().compileDropTables([
      'alpha',
      'beta',
      'gamma',
    ]);
  ...
  it('Works Drop Views Escapes Table Names', () => {
    const statement = new PostgresSchemaGrammar().compileDropViews([
      'alpha',
      'beta',
      'gamma',
    ]);
  ...
  it('Works Drop Types Escapes Table Names', () => {
    const statement = new PostgresSchemaGrammar().compileDropTypes([
      'alpha',
      'beta',
      'gamma',
    ]);
