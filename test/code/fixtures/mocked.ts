...
import ConnectionSession, {
  RunCallback,
} from '../../../src/connections/connection-session';
import DatabaseManager from '../../../src/database-manager';
import { ExpressionContract, GrammarBuilder } from '../../../src/query';
import JoinClause from '../../../src/query/join-clause';
import QueryBuilder from '../../../src/query/query-builder';
import Blueprint from '../../../src/schema/blueprint';
import SchemaBuilder from '../../../src/schema/builders/builder';
import { default as SqliteSchemaBuilder } from '../../../src/schema/builders/sqlite-builder';
import ColumnDefinition from '../../../src/schema/definitions/column-definition';
import SchemaGrammar from '../../../src/schema/grammars/grammar';
...
import SqliteSchemaGrammar from '../../../src/schema/grammars/sqlite-grammar';
...
import DriverConnectionI from '../../../src/types/connection';
import { DBConfig } from '../../../src/types/database-manager';
import {
  Binding,
  BindingExclude,
...
import GrammarBuilderI, {
  Arrayable,
} from '../../../src/types/query/grammar-builder';
import JoinClauseI from '../../../src/types/query/join-clause';
import BlueprintI from '../../../src/types/schema/blueprint';
import { BlueprintCallback } from '../../../src/types/schema/builder/schema-builder';
import {
  MockedConnection,
...
export function getPostgresBlueprint(
  table: string,
...
export function getSqlserverBlueprint(
  table: string,
  callback?: BlueprintCallback,
  prefix?: string,
): BlueprintI {
...
export function getMysqlBlueprint(
  table: string,
  callback?: BlueprintCallback,
  prefix?: string,
): BlueprintI {
...
export function getSqliteBlueprint(
  table: string,
  callback?: BlueprintCallback,
  prefix?: string,
): BlueprintI {
...
export class MockedCacheManager extends CacheManager {
  ...
  public getCacheConfig(
    connectionName: string,
  ): Omit<CacheConfiguration, 'resolver'> {
    return super.getCacheConfig(connectionName);
  }

  public getCacheName(connectionName: string): string | symbol | undefined {
...
export class MockedConnectionSessionWithResults extends MockedConnectionSession {
  ...
  constructor(
    driverConnection: DriverConnectionI,
    results: PdoRowData[],
    columns: string[],
  ) {
  ...
  public prepared(
    ...
    jest
      .spyOn(statement, 'fetchColumn')
      .mockImplementation((column: number) => {
        return {
          get: () => {
...
export class MockedGrammar extends SchemaGrammar {
   ...
   */
  public compileModifyGeneratedAs(
    blueprint: BlueprintI,
    column: ColumnDefinition,
  ): string {
...
export class MockedDatabaseManager<
  const Config extends DBConfig,
> extends DatabaseManager<Config> {
  public createConnection<const T extends keyof Config['connections'] & string>(
    name: T,
  ): any {
