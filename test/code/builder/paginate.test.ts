...
import { getBuilder, MockedBuilder } from '../fixtures/mocked';
...
describe('QueryBuilder Paginate', () => {
  ...
  it('Works Cursor Paginate', async () => {
    ...
    const spiedNewQuery = jest
      .spyOn(builder, 'newQuery')
      .mockImplementation(() => {
  ...
  it('Works Cursor Paginate Multiple Order Columns', async () => {
    ...
    const spiedGet = jest
      ...
      .mockImplementationOnce(async () => {
        ...
        expect(['bar', 'bar', 'foo']).toEqual(
          builder.getRegistry().bindings.where,
        );
        return results;
      });
  ...
  it('Works Cursor Paginate With Union Wheres With Raw Order Expression', async () => {
    ...
    const results = [
      {
        id: 1,
        created_at: '2023-03-25 15:10:00',
        type: 'video',
        is_published: true,
      },
      {
        id: 2,
        created_at: '2023-03-25 15:11:00',
        type: 'news',
        is_published: true,
      },
    ];
