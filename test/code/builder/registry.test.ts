...
import IndexHint from '../../../src/query/index-hint';
import createRegistry, { cloneRegistry } from '../../../src/query/registry';
import { Binding } from '../../../src/types/generics';
import {
  OrderColumn,
  OrderRaw,
  WhereBetween,
...
describe('QueryBuilder Registry', () => {
  ...
  it.each(['Date', 'Time', 'Year', 'Month', 'Day'])(
    'Works Clone Where %s',
    (param: string) => {
