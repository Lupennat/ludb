...
describe('Json', () => {
  const data: Array<[string, boolean, string, any?]> = [
    ...
    [
      'nested key exists and not null',
      false,
      'nested->value',
      { nested: { value: false } },
    ],
    ...
    [
      'multiple array index not exists',
      true,
      '[0][0]',
    ...
    [
      'nested array index not exists',
      true,
      'nested[0]',
      { nested: [undefined, 'nested->invalid'] },
    ],
    [
      'nested array index exists and null',
      true,
      'nested->value[1]',
      { nested: { value: [0, null] } },
    ],
    ...
    [
      'nested array index exists and not null',
      false,
      'nested->value[1]',
